...
class UScriptStruct* FFMODEventControlKeyStruct::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern FMODSTUDIOEDITOR_API uint32 Get_Z_Construct_UScriptStruct_FFMODEventControlKeyStruct_CRC();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FFMODEventControlKeyStruct, Z_Construct_UPackage__Script_FMODStudioEditor(), TEXT("FMODEventControlKeyStruct"), sizeof(FFMODEventControlKeyStruct), Get_Z_Construct_UScriptStruct_FFMODEventControlKeyStruct_CRC());
	}
	return Singleton;
}
...
static struct FScriptStruct_FMODStudioEditor_StaticRegisterNativesFFMODEventControlKeyStruct
{
...
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FFMODEventControlKeyStruct_Statics::NewProp_Value = { UE4CodeGen_Private::EPropertyClass::Enum, "Value", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000001, 1, nullptr, STRUCT_OFFSET(FFMODEventControlKeyStruct, Value), Z_Construct_UEnum_FMODStudio_EFMODEventControlKey, METADATA_PARAMS(Z_Construct_UScriptStruct_FFMODEventControlKeyStruct_Statics::NewProp_Value_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FFMODEventControlKeyStruct_Statics::NewProp_Value_MetaData)) };
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FFMODEventControlKeyStruct_Statics::NewProp_Value_Underlying = { UE4CodeGen_Private::EPropertyClass::Byte, "UnderlyingType", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0000000000000000, 1, nullptr, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FFMODEventControlKeyStruct_Statics::ReturnStructParams = {
		...
		Z_Construct_UScriptStruct_FFMODEventControlKeyStruct_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UScriptStruct_FFMODEventControlKeyStruct_Statics::PropPointers),
	...
	{
#if WITH_HOT_RELOAD
		extern uint32 Get_Z_Construct_UScriptStruct_FFMODEventControlKeyStruct_CRC();
		UPackage* Outer = Z_Construct_UPackage__Script_FMODStudioEditor();
		static UScriptStruct* ReturnStruct = FindExistingStructIfHotReloadOrDynamic(Outer, TEXT("FMODEventControlKeyStruct"), sizeof(FFMODEventControlKeyStruct), Get_Z_Construct_UScriptStruct_FFMODEventControlKeyStruct_CRC(), false);
#else
	...
	uint32 Get_Z_Construct_UScriptStruct_FFMODEventControlKeyStruct_CRC() { return 3360917651U; }
